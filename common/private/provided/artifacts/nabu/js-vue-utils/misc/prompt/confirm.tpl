<template id="n-confirm">
	<div class="n-confirm">
		<div v-if="type" class="n-confirm-icon"><span class="info n-icon" :class="{'n-icon-question-circle-o': type == 'question', 'n-icon-exclamation-triangle': type == 'warning', 'n-icon-exclamation-circle': type == 'error' }"></span></div>
